...
_PREFILL_CANONICAL_STEP = 256


_PREFILL_ARITHMETIC_STEP = ContextVar("prefill_arithmetic_step", default = 256)


_PREFILL_MAX_CHUNK_SIZE = 1024
...
class DynamicPrefillSchedule:
    ...
    @staticmethod
    @contextmanager
    def arithmetic(model, step_size = _PREFILL_CANONICAL_STEP):
        changed = []
        ...
        try:
            for _, module in model.language_model.named_modules():
                ...
                if _has_supported_prefill_attention(base):
                    ...
                    step_size != _PREFILL_CANONICAL_STEP
