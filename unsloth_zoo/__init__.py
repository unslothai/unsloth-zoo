...
if _is_mlx_only:
    # MLX-only mode: skip all CUDA/torch-specific initialization.
    # MLX modules (mlx_utils, mlx_loader, mlx_trainer) are imported directly.
    os.environ["UNSLOTH_ZOO_IS_PRESENT"] = "1"
    del _is_mlx_only, find_spec, os, warnings, re
