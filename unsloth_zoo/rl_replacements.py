...
class UnslothEfficientGRPO(torch.autograd.Function):
    # All Unsloth Zoo code licensed under LGPLv3
    @staticmethod
    def forward(ctx, _new_hidden_states, _old_hidden_states, _ref_hidden_states, lm_head, _input_ids, _mask, _advantages, beta, 
                scaler = None, n_chunks = 1, extra_kwargs=None):
        ...
        def compute_loss(new_hidden_states, old_hidden_states, ref_hidden_states,input_ids, mask, advantages, scaling):
            ...
            loss, completion_length, mean_kl = grpo_compute_loss(
                old_logits, new_logits,ref_logits, input_ids, mask, beta, advantages,  **extra_kwargs
            )
