...
def patch_Gemma3ForConditionalGeneration_forward():
    try:
    ...
    if old_keys != new_keys:
        print("Unsloth: Failed to patch Gemma3ForConditionalGeneration.forward")
    else:
        transformers.models.gemma3.modeling_gemma3.Gemma3ForConditionalGeneration.forward = forward
    return
pass
TEMPORARY_PATCHES.append(patch_Gemma3ForConditionalGeneration_forward)
